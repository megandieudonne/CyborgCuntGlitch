...
<h2>About</h2>
<p>This is an effort to (re-)build a practice of 'reflective thinking' — To not settle for the current story of technology and how it's told; by the same figures and systems, but through those vital narratives made less visible. Partly motivated by and against the backdrop of <i>Cyborg Cunt Glitch</i> — all told together & part of — the common language spoken on and away from our* screens.</p>
...
<p>To keep things tidy for the Downloads folder, folders are organised alphabetically by First Name, Last Name. File types are mostly: .pdf, .jpg, .png and are named by Title, (Year).</p>
